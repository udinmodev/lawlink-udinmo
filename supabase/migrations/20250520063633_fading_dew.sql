...
-- Create group_members table with explicit foreign key names
...
-- Create group_invites table with explicit foreign key names
...
-- Create followers table with explicit foreign key names
